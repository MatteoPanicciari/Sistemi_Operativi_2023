...
kernel : ./phase1/p1test.o ./phase1/msg.o ./phase1/pcb.o ./phase2Umps3/p2test.o ./phase2Umps3/initial.o ./phase2Umps3/scheduler.o ./phase2Umps3/utile.o crtso.o libumps.o
	$(LD) -o $@ $^ $(LDFLAGS)
